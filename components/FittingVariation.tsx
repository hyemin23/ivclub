...
const FittingVariation: React.FC = () => {
  ...
  const angleOptions = [
    ...
    { id: 'left-30', label: '좌측 측면(30°)', icon: <CornerUpLeft className="w-3 h-3" /> },
    { id: 'left-40', label: '좌측 측면(40°)', icon: <CornerUpLeft className="w-3 h-3 rotate-12" /> },
    { id: 'right-30', label: '우측 측면(30°)', icon: <CornerUpRight className="w-3 h-3" /> },
    { id: 'right-40', label: '우측 측면(40°)', icon: <CornerUpRight className="w-3 h-3 -rotate-12" /> },
    { id: 'left-side', label: '완전 좌측(90°)', icon: <MoveLeft className="w-3 h-3" /> },
    { id: 'right-side', label: '완전 우측(90°)', icon: <MoveRight className="w-3 h-3" /> },
