...
import { Layers, RefreshCw, UserCheck, Zap, PlusSquare, ImagePlus, Wallpaper } from 'lucide-react';
      ...
      <div className="flex flex-wrap gap-2 bg-white/5 p-1.5 rounded-2xl border border-white/10 w-fit">
        {modes.map((mode) => (
          <button 
            ...
            className={`px-6 py-3 rounded-xl text-[11px] font-black uppercase tracking-widest flex items-center gap-2 transition-all ${
              subMode === mode.id 
        ...
        <button 
          disabled
          className="px-6 py-3 rounded-xl text-[11px] font-black uppercase tracking-widest flex items-center gap-2 text-gray-700 opacity-30 cursor-not-allowed"
        >
